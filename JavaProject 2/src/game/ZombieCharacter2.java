...
public class ZombieCharacter2 extends Walker {
    ...
    /**
     * Represents the shape of the ZombieCharacter2.
     */

    private static final Shape shape = new PolygonShape(-0.55f,1.97f, -1.4f,0.25f, -1.41f,-2.38f, 0.13f,-2.33f, 1.21f,0.22f, 1.01f,1.62f);

    /**
     * Represents the image of the ZombieCharacter2.
     */

    private static final BodyImage image = new BodyImage("data/zombie2.png",5.0f);
    ...
    public ZombieCharacter2(World world) {
        super(world, shape);
        addImage(image);
        healthCount = 100;
    }
